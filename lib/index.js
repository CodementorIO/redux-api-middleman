...
exports.MAX_REPLAY_TIMES = exports.CHAIN_API = exports.CALL_API = undefined;
...
var MAX_REPLAY_TIMES = exports.MAX_REPLAY_TIMES = 2;
...
exports.default = function (_ref2) {
  ...
  var _ref2$maxReplayTimes = _ref2.maxReplayTimes;
  var maxReplayTimes = _ref2$maxReplayTimes === undefined ? MAX_REPLAY_TIMES : _ref2$maxReplayTimes;
...
function createRequestPromise(_ref4) {
  ...
  var maxReplayTimes = _ref4.maxReplayTimes;
  ...
  return function (prevBody) {
    ...
    return new _bluebird2.default(function (resolve, reject) {
      function sendRequest() {
        ...
        request.set(defaultParams.headers).query(queryObject).send(sendObject).end(function (err, res) {
...
function paramsExtractor(_ref5) {
  ...
  return function (callApi) {
    ...
    var _callApi$decamelizeRe = callApi.decamelizeRequest;
    var decamelizeRequest = _callApi$decamelizeRe === undefined ? true : _callApi$decamelizeRe;
